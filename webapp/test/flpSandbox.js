			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cboxbinding-display": {
								"semanticObject": "cboxbinding",
								"action": "display",
								"description": "Carga de dados usando json local",
								"title": "Data Binding",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cboxbinding",
									"url": sap.ui.require.toUrl("cboxbinding")
								}
							}
						}
					}
